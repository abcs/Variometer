...
void boardInit(void) {
   ...
   */
  LPC_IOCON->PIO0_6 = 0x81;				/* Enable USB_CONNECT function */
  LPC_IOCON->PIO0_7 = 0x80;             /* Disables pull-up on LED2 output.      */
  LPC_IOCON->PIO1_19 = 0x80;			/* Disables pull-up on BACKLIGHT output. */
  LPC_IOCON->PIO1_24 = 0x80;
  LPC_IOCON->PIO1_25 = 0x80;            /* Disables pull-up on LCD RES output.   */

  /* SSP0 mapping.*/
  LPC_IOCON->PIO1_29 = 0x81;            /* SCK0 without resistors.          */
  LPC_IOCON->PIO0_2  = 0x81;            /* SSEL0 without resistors.         */
  LPC_IOCON->PIO0_8  = 0x81;            /* MISO0 without resistors.         */
  LPC_IOCON->PIO0_9  = 0x81;            /* MOSI0 without resistors.         */
  LPC_IOCON->PIO0_20 = 0x80;            /* C/D without resistors.           */
  ...
  LPC_IOCON->PIO1_31 = 0x80;            /* HP03M XCLR - No pull-up, output  */
}
