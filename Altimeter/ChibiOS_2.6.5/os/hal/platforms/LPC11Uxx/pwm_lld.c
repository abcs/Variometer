...
void pwm_lld_init(void) {
  ...
  pwmObjectInit(&PWMD1);
  PWMD1.tim = LPC_CT16B0;	//LPC_TMR16B0
  ...
  /* Driver initialization.*/
  pwmObjectInit(&PWMD2);
  PWMD2.tim = LPC_CT16B1;	//LPC_TMR16B1
  ...
  /* Driver initialization.*/
  pwmObjectInit(&PWMD3);
  PWMD3.tim = LPC_CT32B0;	//LPC_TMR32B0
  ...
  /* Driver initialization.*/
  pwmObjectInit(&PWMD4);
  PWMD4.tim = LPC_CT32B1;	//LPC_TMR32B1
...
void pwm_lld_start(PWMDriver *pwmp) {
  ...
  /* Output enables and polarities setup.*/
    ...
    pr = (uint16_t)((LPC_SYSCLK / pwmp->config->frequency) - 1);
    chDbgAssert(((uint32_t)(pr + 1) * pwmp->config->frequency) == LPC_SYSCLK,
